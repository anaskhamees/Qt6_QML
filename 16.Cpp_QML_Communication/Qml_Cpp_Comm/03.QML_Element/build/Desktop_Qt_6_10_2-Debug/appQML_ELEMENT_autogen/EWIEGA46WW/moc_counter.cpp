...
template <> constexpr inline auto Counter::qt_create_metaobjectdata<qt_meta_tag_ZN7CounterE_t>()
{
    ...
    QtMocHelpers::UintData qt_properties {
        // property 'value'
        QtMocHelpers::PropertyData<int>(5, QMetaType::Int, QMC::DefaultPropertyFlags | QMC::Writable | QMC::StdCppSet | QMC::Final, 0),
    };
    ...
    return QtMocHelpers::metaObjectData<Counter, void>(QMC::MetaObjectFlag{}, qt_stringData,
